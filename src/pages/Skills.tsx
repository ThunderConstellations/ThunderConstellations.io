      ...
      <div className="max-w-7xl mx-auto pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          {[
            ...
            <div key={index} className="glass-morphism p-6 rounded-xl text-center animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-morphism p-6 rounded-xl animate-fade-in" style={{ animationDelay: '0.6s' }}>
          ...
          <div className="glass-morphism p-6 rounded-xl animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <h3 className="text-2xl font-bold text-cosmic-gold mb-6 flex items-center gap-2">
                ...
                <div key={index} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-24 bg-cosmic-starlight/20 rounded-full h-2">
                      <div 
                        className="bg-cosmic-gold h-2 rounded-full transition-all duration-1000 animate-fade-in"
                        style={{ 
                          width: `${skill.level}%`,
        ...
        <div className="mt-12 glass-morphism p-8 rounded-xl animate-fade-in" style={{ animationDelay: '1s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-cosmic-gold/10 to-cosmic-gold/20 p-4 rounded-lg border border-cosmic-gold/30 hover:scale-105 transition-transform duration-300">
